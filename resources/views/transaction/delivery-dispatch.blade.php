            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-body table-responsive">
                      ...
                      <h3 style="margin-bottom: 20px;">Dispatch</h3>
    ...
    <div class="modal-dialog modal-xl" style="width: 1000px;" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <form action="{{ action('Transaction\DeliveryCtr@doDeliver') }}" method="POST">  
            @csrf              
          ...
          {{--<button class="btn btn-outline-dark btn-sm" id="btn-gen-sales-inv"><span class='fa fa-print'></span> Generate Sales Invoice</button> --}}
            <button style="color: #fff" class="btn btn-sm btn-success" type="submit">Deliver</button>
          </form> 
